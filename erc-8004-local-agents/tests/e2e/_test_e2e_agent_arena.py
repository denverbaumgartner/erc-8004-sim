...
class TestAgentArenaE2E:
    ...
    async def test_agent_arena_interactive(
        ...
        base_server_01: BaseServer,
        base_agent_02: ChainedAgent,
        ...
        Args:
            base_server: First agent server (on port 8001)
            base_server_01: Second agent server (on port 8002)
            base_agent_02: Client agent (will send messages to other two)
            ethereum_tester_provider: EthereumTester provider for transaction export
            contract_objects: Contract instances for decoding transaction logs
        """
